...
customer = [('John Doe', 'email', '1301 E Main St', 'Madison', 'TN', 'zipcode', 'phone', 2, 1, '1-27-18')]#10 things
...
c.executemany('INSERT INTO employee VALUES(?, ?, ?, ?, ?, ?, ?, ?)', employee)  #USED TO BE EMPLOYEES NOT SINGULAR, ASK
...
todo = [('todotype', 4, 2, 0, '1-27-18')]#5 things
c.executemany('INSERT INTO todo VALUES(?, ?, ?, ?, ?)', todo)

user = [('email', 'password', 4, 3, 2, 1, '1-27-18')]#7 things
