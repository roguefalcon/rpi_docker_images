...
$servers->setValue('server','name','KP OpenLDAP');
...
$servers->setValue('server','host','192.168.1.139');
...
$servers->setValue('server','base',array('dc=pyatt,dc=lan'));
...
/* The DN of the user for phpLDAPadmin to bind with. For anonymous binds or
   ...
   binds. */
$servers->setValue('login','bind_id','cn=admin,dc=pyatt,dc=lan');
